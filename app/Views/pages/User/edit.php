        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <form action="<?= route_to('users/(.*)' . $users->id); ?>" method="POST" autocomplete="off">
                        <div class="card-body">
                            <?= csrf_field() ?>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input name="username" value="<?= old('username', $users->username); ?>" type="text" class="form-control <?= isset($errors['username']) ? 'is-invalid' : null ?>" id="username" placeholder="Masukkan nama pengguna" />
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input name="email" value="<?= old('email', $users->email); ?>" type="email" class="form-control <?= isset($errors['email']) ? 'is-invalid' : null ?>" id="email" placeholder="Masukkan email pengguna" />
                                        <div class="invalid-feedback">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control <?= isset($errors['group_id']) ? 'is-invalid' : null ?>" name="group_id" id="group_id">
                                            <option value="" selected>Pilih peran</option>
                                            <?php foreach ($auth_groups as $key => $value) :  ?>
                                                <option value="<?= $value->id ?>" <?= $value->id == $selected_group ? 'selected' : '' ?>><?= $value->name; ?></option>
                                            <?php endforeach ?>
                                        </select>
                                        <div class="invalid-feedback">
