                ...
                <div class="card">
                    <div class="card-header">
                        <div class="card-head-row">
                            <div class="card-title">Buat Peran</div>
                        </div>
                    </div>
                    <?php $errors = session()->getFlashdata('errors') ?>
                    <form action="<?= route_to('auth-groups'); ?>" method="POST" autocomplete="off">
                        <div class="card-body">
                            <?= csrf_field() ?>
                            <div class="row">
                                <div class="col-md-6 col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input name="name" value="<?= old('name'); ?>" type="text" class="form-control <?= isset($errors['name']) ? 'is-invalid' : null ?>" id="name" placeholder="Masukkan nama peran" />
                                        ...
                                        <div class="selectgroup selectgroup-pills">
                                            <?php foreach ($auth_permissions as $key => $value) :  ?>
                                                <label class="selectgroup-item">
                                                    <input type="checkbox" name="permission_id[]" value="<?= $value->id; ?>" class="selectgroup-input" />
