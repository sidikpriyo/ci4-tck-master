                ...
                <div class="card">
                    <div class="card-header">
                        <div class="card-head-row">
                            <div class="card-title">Daftar Izin</div>
                            <div class="card-tools d-flex align-items-center">
                                ...
                                <a href="<?= route_to('auth-permissions/new'); ?>" class="btn btn-label-success btn-round btn-sm me-2">
                            ...
                            <table class="table table-bordered">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-uppercase">nama izin</th>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center" style="width: 15%;">
                                                <div class="d-inline-flex gap-1">
                                                    <a href="<?= route_to('auth-permissions/(.*)/edit', $value->id); ?>" class="btn btn-label-warning btn-sm">
                                                    ...
                                                    <div class="modal fade" id="modal-delete-user-<?= $value->id ?>">
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                <form action="<?= site_url('auth-permissions/' . $value->id); ?>" method="post">
                                                                    <?= csrf_field(); ?>
